...
public sealed class SqliteUsageEventLedger : IAsyncDisposable
{
    ...
    private async Task<SqliteConnection> Open(CancellationToken token)
    {
        ...
        try
        {
            ...
            if (version > 1) throw new NotSupportedException("Unsupported future usage ledger schema.");
    ...
    private static readonly string Schema = $"""
        ...
        INSERT INTO usage_schema_meta VALUES('usage_ledger',1) ON CONFLICT(component) DO NOTHING;
